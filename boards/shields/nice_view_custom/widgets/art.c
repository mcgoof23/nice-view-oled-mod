...
#ifndef LV_ATTRIBUTE_IMG_EDGERUNNER
#define LV_ATTRIBUTE_IMG_EDGERUNNER
#endif

const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_LARGE_CONST LV_ATTRIBUTE_IMG_EDGERUNNER uint8_t edgerunner_map[] = {
#if CONFIG_NICE_VIEW_WIDGET_INVERTED
    0x00, 0x00, 0x00, 0xff, /*Color of index 0*/
    0xff, 0xff, 0xff, 0xff, /*Color of index 1*/
#else
  ...
  , 
};

const lv_img_dsc_t edgerunner = {
  .header.cf = LV_IMG_CF_INDEXED_1BIT,
  .header.always_zero = 0,
  .header.reserved = 0,
  .header.w = 42,
